package com.pavlmir.pavlmirp2p.Receivers;
	...
	public void onReceive(Context context, Intent intent) {
		...
		**********************************/
		if(action.equals(WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION)){
			Log.v(TAG, "P2P_STATE_CHANGED_ACTION");
...
//			Log.v(TAG, "WIFI_P2P_PEERS_CHANGED_ACTION");
		...
		***************************************/
			...
			Log.v(TAG, "P2P_THIS_DEVICE_CHANGED_ACTION");
		...
		******************************************************************/
			...
			Log.v(TAG, "P2P_CONNECTION_CHANGED_ACTION");
